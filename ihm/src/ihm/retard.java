 ...
 * @author Lenovo
 */
public class retard extends javax.swing.JFrame {
Statement stmt;
connexionBD conn = new connexionBD();DefaultTableModel aaa;
    /**
     * Creates new form retard
     */
    public retard() {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Par travailleur");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            ResultSet result =stmt.executeQuery("SELECT * FROM retard;" );//execute la requete
...
aaa.setRowCount(0);
while(result.next()){
int idPatient=result.getInt("idtrav");
String date=result.getString("date");



Object[] aa ={idPatient,date};
...
aaa.addRow(aa);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            stmt =conn.getconnexionBD().createStatement();
            String b="SELECT * FROM retard";
            ResultSet result =stmt.executeQuery(b);//execute la requete
            //JOptionPane.showMessageDialog(null,"requete succes");afiche que la requete a marcher
            aaa=new DefaultTableModel();
            aaa.addColumn("id");
            ...
            aaa.setRowCount(0);
            while((result.next())){
                String date3= date1.format(result.getDate("date"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            while((result.next())){
                ...
                if(id.equals(result.getString("idtrav"))){
                    SimpleDateFormat date1 =new SimpleDateFormat("yyyy-MM-dd");
                    String date= date1.format(result.getDate("date"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(retard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
